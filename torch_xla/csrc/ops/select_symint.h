...
class SelectSymInt : public XlaNode {
 public:
  SelectSymInt(const torch::lazy::Value& input, int64_t dim,
               const torch::lazy::Value& start, const torch::lazy::Value& end,
               const torch::lazy::Value& stride, xla::Shape output_shape);
