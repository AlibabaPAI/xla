...
ViewSymIntOp::ViewSymIntOp(const torch::lazy::Value& input,
    ...
    : XlaNode(
          ...
          torch::lazy::MHash(
              ...
              torch::lazy::ToVector<bool>(output_shape.dynamic_dimensions()))), // TODO: check this hash
      upper_bounds_(torch::lazy::ToVector<int64_t>(output_shape.dimensions())),
      dynamic_dims_(torch::lazy::ToVector<bool>(output_shape.dynamic_dimensions())) {}
...
XlaOpVector ViewSymIntOp::Lower(LoweringContext* loctx) const {
  ...
  xla::XlaOp output = BuildViewSymInt(input, size_ops, upper_bounds_, dynamic_dims_);
