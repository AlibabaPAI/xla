...
xla::XlaOp BuildThreshold(xla::XlaOp input, xla::XlaOp output,
  ...
  if (input_shape.is_dynamic()) {
    xla::XlaOp xla_value = XlaHelpers::DynamicScalarBroadcast(
        value, output_shape.element_type(), input);
    return xla::Select(xla::Gt(input, xla_threshold), output, xla_value);
  }
